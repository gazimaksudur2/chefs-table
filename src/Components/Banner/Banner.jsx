    ...
    return (
        <div className='banner-cont relative my-10 h-[80vh] bg-img bg-cover rounded-3xl'>
            ...
            <div className="absolute z-10 p-2 w-full banner-tags text-center h-full space-y-10 flex flex-col justify-center items-center">
                ...
                <p className='text-white text-sm md:text-lg font-normal md:w-1/2'>Indulge in a symphony of flavors curated by our talented chefs, who blend tradition with innovation to create dishes that are as visually stunning as they are delicious.</p>
